    ...
    <div className={"container"}>
      <div className={"content"}>
        ...
        <p>
          ...
          <strong>you</strong>), and <strong>Roadgauge</strong>, doing business
          as<strong> Roadgauge</strong>{" "}
          <strong>(https://Roadgauge.app) </strong>website as well as any
        ...
        <p>
          ...
          https://Roadgauge.app/privacy, which sets out the terms on which we
        ...
        <p>
          ...
          contact@Roadgauge.app, which sets out the permitted uses and
          prohibited uses of the Site. When using the Site, you must comply with
        ...
        <p>
          2.1 Our full Acceptable Use Policy contact@Roadgauge.app, sets out all
        ...
        <p>
          ...
          password you must promptly notify us at contact@hitstaff.app.
        </p>
        <p>
        ...
        <p>
          ...
          please contact us at contact@hitstaff.app or use the take down or
          report button. &nbsp;&nbsp;&nbsp;
        </p>
        ...
        <p>
          ...
          by contacting us at contact@hitstaff.app. &nbsp;
        </p>
        <p>
        ...
        <p>
          ...
          contact us by email at contact@hitstaff.app
        </p>
      </div>
    </div>
  </Layout>
